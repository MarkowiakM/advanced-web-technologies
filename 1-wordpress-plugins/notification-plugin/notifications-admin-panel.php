...
class NotificationAdminPanel
{
    ...
    function notification_admin_page()
    {
        ...
        if (isset($_POST['notification']) && isset($_POST['notification_name'])) {
            array_push($notifications, $_POST['notification']);
            array_push($notifications_names, $_POST['notification_name']);
            echo '<div class="notice notice-success isdismissible"><p>New notification added.</p></div>';
            //edit notification
        } else if (isset($_POST['notification-edit'])) {
            $notifications[$_POST['notification-nr']] = $_POST['notification-edit'];
            echo '<div class="notice notice-success isdismissible"><p>Eddited notification.</p></div>';
        }
        //delete notification
        ...
        <div class="wrap">
            ...
            <form name="add_form" method="post" id="new-notification-form" class="new-notification-form hide page-section">
                ...
                <div>
                    ...
                    <textarea type="text" name="notification" required placeholder="Insert your html code here"></textarea>
